...
#import "PicasoNavigationController.h"

@interface PicasoNavigationController () <UIGestureRecognizerDelegate, UIScrollViewDelegate> {
...
@implementation PicasoNavigationController
